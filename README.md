...
- **Экспорт/Импорт Excel**: Сохранение данных в чистый XLSX-файл с единственным листом «Gallery Data». Список удаленных картинок теперь вычисляется на лету при импорте, что исключает создание лишних технических вкладок.
