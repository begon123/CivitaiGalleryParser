...
- **Умный сканер (v1.5+)**: Продвинутый алгоритм с авто-разблокировкой скролла, обходом модальных окон и глубокой симуляцией действий пользователя для максимального нахождения изображений (49+ на страницу).
...
- **Извлечение параметров генерации (v1.6+)**: Автоматический сбор текстовых описаний (промптов) изображений непосредственно со страниц Civitai в фоновом режиме.
