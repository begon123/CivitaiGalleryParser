...
- Использовать фильтры в центре подвала: **"Все"**, **"Новые"**, **"Изменённые (минус)"** (для отображения изображений с уменьшением реакций), **"Изменённые"** (общий список изменений), **"Изменённые (плюс)"** (для отображения изображений с увеличением реакций), **"Удалённые"** (подвал зафиксирован и всегда отображается в нижней части экрана).
