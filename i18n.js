...
const I18N = {
  ...
  strings: {
    en: {
      ...
      results_filter_changed_minus_title: 'Changed (minus)',
      results_filter_changed_plus_title: 'Changed (plus)',
    ...
    ru: {
      ...
      results_filter_changed_minus_title: 'Изменённые (минус)',
      results_filter_changed_plus_title: 'Изменённые (плюс)',
